...
export const meetupSessions: MeetupSession[] = [
  {
    ...
    description: "개취뽀의 첫 번째 모임으로, 코딩테스트부터 면접까지 취업 전반에 관한 이야기를 나누었습니다.",
    attendees: 60,
    speakers: [
      {
        id: "airodo-backend",
        ...
        presentation: {
          ...
          description: "코딩테스트 준비 방법과 실전 팁, 문제 해결 전략을 실제 경험을 바탕으로 공유합니다.",
          slides: "https://docs.google.com/presentation/d/1aUghrg0xG_5G8xSPK4PxyW1S4K8paDCEK1o2HYpoEew/edit#slide=id.p",
        },
      ...
      },
      {
        ...
        presentation: {
          title: "수능 6등급에서 토스까지",
          description: "학력과 상관없이 개발자로 성장할 수 있다는 것을 보여주는 실제 경험담입니다.",
          slides:
      ...
      },
      {
        ...
        presentation: {
          ...
          description: "신입 개발자 관점에서 자기소개서 작성법과 면접 준비 노하우를 공유합니다.",
        },
      ...
      },
      {
        ...
        presentation: {
          ...
          description: "비전공자에서 실리콘밸리 개발자가 되기까지의 여정과 노하우를 공유합니다.",
          slides:
    ...
    video: {
      thumbnail: "https://i.ytimg.com/an_webp/EzBdmvk2Utk/mqdefault_6s.webp?du=3000&sqp=COv4usIG&rs=AOn4CLBqT1ugtYa-s1ybvCmAbkfduHtGlQ",
  ...
  },
  {
    ...
    description: "기술면접 준비부터 연봉협상까지, 취업의 핵심 포인트들을 다룬 두 번째 모임입니다.",
    attendees: 60,
    speakers: [
      {
        id: "jang-younghwan",
        ...
        presentation: {
          ...
          description: "빅테크 기업 면접 과정과 연봉협상 전략을 생생하게 공유합니다.",
          slides:
      ...
      },
      {
        ...
        presentation: {
          ...
          description: "대기업 동시 합격을 위한 체계적인 준비 방법과 전략을 공유합니다.",
          slides:
      ...
      },
      {
        ...
        presentation: {
          ...
          description: "스타트업에서의 빠른 성장 경험과 선택 이유를 공유합니다.",
          slides:
      ...
      },
      {
        ...
        presentation: {
          title: "커뮤니티로 성장하기",
          description: "개발자 커뮤니티 참여를 통한 성장 방법과 네트워킹 노하우를 공유합니다.",
          slides:
    ...
    video: {
      thumbnail: "https://i.ytimg.com/an_webp/HjaAk4rZ0q0/mqdefault_6s.webp?du=3000&sqp=CKqJu8IG&rs=AOn4CLAOoFygGw2OePSkAN0ciLwmAOu-CA",
  ...
  },
  {
    ...
    location: "서울 광진구 중곡동 138-35 B1층 그린라운지",
    description: "2025년 면접 트렌드와 이직 전략, 그리고 실패를 딛고 일어선 성공 스토리를 다룬 세 번째 모임입니다.",
    attendees: 60,
    speakers: [
      {
        id: "purple-dingco",
        ...
        presentation: {
          ...
          description: "2025년 면접에서 차별화될 수 있는 전략과 기술을 공유합니다.",
          slides: "https://drive.google.com/file/d/19ghmPdMYhrAGbAd0rQDhYJSGCv1_t0wq/view?usp=sharing",
        },
      ...
      },
      {
        ...
        presentation: {
          ...
          description: "실제 경험을 바탕으로 한 기술 면접 준비의 핵심 요소들을 공유합니다.",
          slides: "https://drive.google.com/file/d/1Tf4pufaQlMM4xI5aGKBNIw_h79FaOnpO/view?usp=drive_link",
        },
        skills: ["기술면접", "알고리즘", "시스템설계"],
        contact: {
          github: "https://drive.google.com/file/d/11BSbqkarp4L5TSXGSrkFslLQKWby0YDI/view?usp=drive_link",
        },
      },
      {
        id: "choco-sorabread",
        ...
        presentation: {
          ...
          description: "이직 준비를 위한 체계적이고 균형잡힌 접근 방법을 공유합니다.",
          slides: "https://drive.google.com/file/d/1uIc-xRKIYx37H_EcdkVh6jeH-34ztey1/view?usp=drive_link",
        },
      ...
      },
      {
        ...
        company: "IT 기업",
        position: "개발자",
        topic: "1200번 떨어지고도 웃었다: 데이터로 만든 4개 동시합격. #1200Fail4Win",
        date: "2024.06.08",
        tags: ["실패", "성공", "데이터분석"],
        avatar: "/speakers/oh-taeseok.jpeg",
        bio: "1200번의 실패를 데이터로 분석해 4개 회사 동시 합격을 이뤄낸 놀라운 스토리를 공유합니다.",
        presentation: {
          title: "1200번 떨어지고도 웃었다: 데이터로 만든 4개 동시합격. #1200Fail4Win",
          description: "실패를 데이터로 분석하여 성공으로 이끈 체계적인 접근 방법을 공유합니다.",
          slides: "https://drive.google.com/file/d/1ebJhJlI7vzbPxF5AxVgMayZgZjooo-xQ/view?usp=sharing",
        },
...
export function getTotalSpeakers(): number {
  return meetupSessions.reduce((total, session) => total + session.speakers.length, 0)
}
...
export function getTotalAttendees(): number {
  return meetupSessions.reduce((total, session) => total + session.attendees, 0)
}
...
export function getSessionBySpeakerId(speakerId: string): MeetupSession | undefined {
  return meetupSessions.find((session) => session.speakers.some((speaker) => speaker.id === speakerId))
}
