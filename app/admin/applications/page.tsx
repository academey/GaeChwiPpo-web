...
import { getSpeakerApplications, updateApplicationStatus } from "@/app/actions/speaker-application"
import type { SpeakerApplication } from "@/lib/supabase"
import { Calendar, User, Building, Clock, CheckCircle, XCircle, Loader2 } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">개취뽀 관리자</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Supabase에 저장된 연사 신청서를 관리할 수 있습니다.</p>
        </div>
...
function ApplicationList({ applications, onStatusUpdate, updatingStatus }: ApplicationListProps) {
  ...
  return (
    <div className="grid gap-6">
      {applications.map((application) => (
        <Card key={application.id} className="bg-gray-800/50 border-gray-700 shadow-xl">
          <CardHeader>
