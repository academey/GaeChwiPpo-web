...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "개취뽀 - 개발자 취업을 뽀개는 커뮤니티",
    description: "개발자 취업 준비생과 이직 준비생들이 모여 실무 경험과 노하우를 공유하는 오프라인 모임",
  ...
  return (
    <html lang="ko">
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ["https://open.kakao.com/o/gPI6kTUg", "https://discord.gg/X74q5Yw3Sv"],
              contactPoint: {
                "@type": "ContactPoint",
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-3XSN32BG5T"></script>
