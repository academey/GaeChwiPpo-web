...
function parseRequestParams(request: NextRequest): RequestParams {
...
function validateParams(params: RequestParams): params is ValidatedParams {
  return params.title !== null && params.duration !== null;
}

function sanitizeParams(params: ValidatedParams) {
  return {
...
function truncateParams(params: ValidatedParams) {
  return {
...
function generateBadgeSVG(badgeData: ValidatedParams): string {
  return `
