      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">연사 신청</h1>
            <p className="text-xl text-gray-300 mb-8">개취뽀 커뮤니티에서 여러분의 경험과 노하우를 공유해주세요</p>
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6 text-left">
              <h2 className="text-lg font-semibold text-blue-300 mb-3">📋 신청 안내</h2>
